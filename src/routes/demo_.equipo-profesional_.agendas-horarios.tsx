...
export const Route = createFileRoute("/demo_/equipo-profesional_/agendas-horarios")({
  head: () => ({
    meta: [{ title: "Agendas y horarios | Cloud Esther" }],
  }),
  component: AgendasHorariosPage,
})

function AgendasHorariosPage() {
  return (
    <CloudEstherProvider>
      <AppShell>
        <EquipoSeccion seccion="agendas" />
      </AppShell>
    </CloudEstherProvider>
  )
}